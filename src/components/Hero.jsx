    ...
    return (
        <Section className="pt-[12rem] -mt-[5.25]" crosses crossesOffset="lg:translate-y-[5.25rem]" customPaddings id="hero">
            <div className="container relative">
                <div className="relative z-1 max-w-[62rem] mx-auto text-venter mb-[4rem] md:mb-20 lg:mb-[6rem]">
                    ...
                    <p className="text-base max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
                        Discover the future of technology with our innovative AI-powered software.
                    </p>
                ...
                <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
                    ...
                    <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[48%] mw:w-[138%] lg:-top-[104%]">
